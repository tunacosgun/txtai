...
|:----------|:-------------|------:|
| [Near duplicate image detection](https://github.com/tunacosgun/txtai/blob/master/examples/31_Near_duplicate_image_detection.ipynb) | Identify duplicate and near-duplicate images | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/tunacosgun/txtai/blob/master/examples/31_Near_duplicate_image_detection.ipynb) |
